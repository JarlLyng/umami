...
> **Note:** When deploying to Vercel with Supabase, ensure your `DATABASE_URL` environment variable is set in Vercel's project settings. The connection string should use Supabase's connection pooling (port 6543).
